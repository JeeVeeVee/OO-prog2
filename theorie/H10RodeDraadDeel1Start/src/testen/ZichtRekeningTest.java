package theorie.H10RodeDraadDeel1Start.src.testen;
...
public class ZichtRekeningTest {
    ...
    private domein.ZichtRekening zrek1, zrek2;

    @BeforeEach
    public void before() {
        zrek1 = new domein.ZichtRekening(123456789911L, "Antoon", -500);
        zrek2 = new domein.ZichtRekening(123123456784L, "Carla", -1000);
    }
